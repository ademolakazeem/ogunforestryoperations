...
/*	$remove = new AdminController();
	...
	*/
	...
	//pagination
		...
		$full_sql = "select * from tbl_forest_land_area"; //full sql before split in to pages
...
<div class="content">
						...
						<h4>
 AREA OF FOREST LAND CLASSIFIED BY TYPE AND LOCAL GOVERNMENT AREA</h4>
	
	<table width="727" id="background-image" summary="Meeting Results">
<thead>
                        <tr>
                          <th width="46" align="center" scope="col"><strong>No</strong></th>
                          <th width="147" align="center" scope="col"><strong>Local Govt Area</strong></th>
                          <th width="152" align="center" scope="col"><strong>Range/Charge</strong></th>
                          <th width="113" align="center" scope="col"><span class="td_ele"><strong>High Forest</strong></span></th>
                          <th width="85" align="center" scope="col"><strong>Savannah Forest</strong></th>
         ...
         <td align="center"><?php echo $rs['lga'];?></td>
        <td align="center"><?php echo $rs['range_charge'];?></td>
         <td align="center"><?php echo $rs['high_forest'];?></td>
         <td align="center"><?php echo $rs['Savannah_forest'];?></td>
