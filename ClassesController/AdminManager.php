...
class AdminController
{
    ...
    function mailresetlink($to, $token)
    {
        ...
        $subject = "Ogun Forestry Operations Password recovery System";
        $uri = 'http://' . $_SERVER['HTTP_HOST'];
        $message = '
<html>
<head>
<title>Ogun Forestry Operations Password recovery System</title>
</head>
<body>
<p><em>Dear '.$to.',</em> <br/>
Thank you for using Ogun State Forestry Monitoring System.<br/>
Your email address has being successfully verified. You will now be required to specify your desired password in order for you to complete the password reset exercise.
<br/><br/>
Please click on the following link to reset your password <em><a href="' . $uri . '/reset.php?token=' . $token . '">Reset Password</a></em> or copy and paste <em><a href="' . $uri . '/reset.php?token=' . $token . '">'.$uri . '/reset.php?token=' . $token .'</a></em>  into your browser
<br/><br/>Thank you</p>
...
';
        ...
        $headers .= 'From: Ogun Forestry Operations<info@ogunforestryoperations.com.ng>' . "\r\n";
        ...
        ini_set('sendmail_from', 'info@ogunforestryoperations.com.ng');
        if (mail($to, $subject, $message, $headers)) {
            return '<h1>YOU ARE NOT DONE YET – Email Verification Required!</h1>
