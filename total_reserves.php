...
<div class="content">
						<h4>
					      ...
					      <br>
Total number of Reserves in the State: <?php echo $pageObj->getTotalRow(); ?> </h4>

                                   
                    <table width="727" id="background-image" summary="Meeting Results">
                      <thead>
                        <tr>
                          <th width="46" align="center" scope="col"><strong>No</strong></th>
                          <th width="147" align="center" scope="col"><strong>Name</strong></th>
                          <th width="152" align="center" scope="col"><strong>Location</strong></th>
                          <th width="113" align="center" scope="col"><span class="td_ele"><strong>Total Area</strong></span></th>
                          <th width="85" align="center" scope="col"><strong>Established Year</strong></th>
                          <th width="156" align="center" scope="col"><strong>Remarks</strong></th>
                        </tr>
                      </thead>
                      <tfoot>
                        <tr>
				  ...
				  <?php //echo ++$sl_start; ?>
                        <tr>
             <td align="center"><?php echo $rs['id'];?> 
             </td>
         <td align="center"><?php echo $rs['forest_name'];?></td>
        <td align="center"><?php echo $rs['forest_location'];?></td>
         <td align="center"><?php echo $rs['total_area'];?></td>
         <td align="center"><?php echo $rs['established_year'];?></td>
 <td align="center"><?php echo $rs['remarks'];?></td>
 </tr>
                        <?php $i++;}?>
                      </tbody>
                      <tfoot>
