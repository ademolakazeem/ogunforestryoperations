...
<?php 	
	...
	//pagination
		...
		$full_sql = "select * from tbl_contractor_transaction_history where contractor_id='$con_id' order by date desc"; //full sql before split in to pages
...
if (isset($_POST['search']))
	...
	//pagination
		...
		$full_sql = "select * from tbl_contractor_transaction_history where contractor_id ='$con_id'";
		$display_links = 11; //number of links to be displayed - odd number
...
<div class="content">
						<h4>
					      ...
					      <br>
				        Total Existing History: <?php echo $pageObj->getTotalRow(); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a href="_new_contractor_account.php" title="Create New Contractor" class="green">Create New Contractor Account</a></h4>
