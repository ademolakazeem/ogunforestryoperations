...
if (isset($_POST['search']))
	...
	//pagination
        ...
        //$full_sql_ct = "select sum(amount_deposited)amount from tbl_contractor_transaction_history where contractor_id ='$keyword' && reserved_location = '$location' order by date desc, contractor_id";
        ...
        //$full_sql_ct = "select sum(amount_deposited)amount from tbl_contractor_transaction_history where contractor_id ='$keyword' && (reserved_location NOT IN (SELECT forest_location from tbl_location WHERE id = 10)) order by date desc, contractor_id";
        }
		else
		{
            $full_sql = "select * from tbl_contractor_transaction_history where contractor_id ='$keyword' order by date desc, contractor_id";
           // $full_sql_ct = "select sum(amount_deposited)amount from tbl_contractor_transaction_history where contractor_id ='$keyword' order by date desc, contractor_id";
        }
		$display_links = 11; //number of links to be displayed - odd number
