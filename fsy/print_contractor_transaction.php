...
$qry1 = "SELECT a.*, b.name name, b.hammer_number hammer_number FROM tbl_contractor_transaction a, tbl_contractor b WHERE a.contractor_id=b.id and a.id = '$transaction_id' && reserved_location = '$location'";	
	...
	<div id="content">
	  ...
	  <div id="invoice_body">
			...
			<tr style="background:#eee;">
			 ...
			 <td>&nbsp;</td> </tr>
                <tr style="background:#eee;">
                    <td style="width:8%;"><strong>Pass Hammer No:</strong></td>
                    <td><?php echo $rs1['phn']; ?></td>
                    <td>&nbsp;</td> </tr>
                <tr style="background:#eee;">
                    <td style="width:8%;"><strong>Stump Number:</strong></td>
                    <td><?php echo $rs1['snl']; ?></td>
                    <td>&nbsp;</td> </tr>
                <tr style="background:#eee;">
                    <td style="width:8%;"><strong>Location:</strong></td>
                    <td><?php echo $rs1['locn']; ?></td>
                    <td>&nbsp;</td> </tr>
                <tr style="background:#eee;">
                    <td style="width:8%;"><strong>Serial No on the Printout:</strong></td>
                    <td><?php echo $rs1['snop']; ?></td>
                    <td>&nbsp;</td> </tr>
			<tr style="background:#eee;">
