...
<?php 
    ...
    $snl=mysql_real_escape_string($_POST['snl']);
    $locn=mysql_real_escape_string($_POST['locn']);
    //End New ones
...
$minshr = "SNOP";
$curDate=date('YmdHis');
$snop = $minshr.$curDate;//.$serial;//generate
...
<?php	
  ...
  <tr>
    ...
    <td align="left"><?php echo $reserved_location;?>
     ...
     <!--We just started adding this -->
     <tr>
         <td align="left">Pass Hammer No:</td>
         <td><?php echo $phn;?><input name="phn" type="hidden" id="phn" value="<?php echo $phn;?>"/></td>
     </tr>
     <tr>
         <td>&nbsp;</td>
         <td>&nbsp;</td>
     ...
     <tr>
         <td align="left">Stump Number:</td>
         <td><?php echo $snl;?><input name="snl" type="hidden" id="snl" value="<?php echo $snl;?>"/></td>
     ...
     <tr>
         ...
         <td><?php echo $locn;?><input name="locn" type="hidden" id="locn" value="<?php echo $locn;?>"/></td>
     </tr>
     <tr>
         <td>&nbsp;</td>
         <td>&nbsp;</td>
     ...
     <tr>
         <td align="left">Serial No on the Printout:</td>
         <td><?php echo $snop;?><input name="snop" type="hidden" id="snop" value="<?php echo $snop;?>"/></td>
