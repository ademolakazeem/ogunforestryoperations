...
if($acc_level == 1 || $acc_level == 3 || $acc_level == 4)
{}
else
{
...
<table width="100%" border="0" cellspacing="5" cellpadding="5">
 ...
 <div> <fieldset>
    <legend>Search by Contractor ID:</legend><br/>   
<table width="350" border="0" align="left">
  <tr><td height="12">Contractor's Id:</td>
  <td colspan="2" align="left" valign="top">
   <input type="text" name="keyword" id="keyword" size="20"/></td>
  </tr>
  <tr>
    <td height="12">&nbsp;</td>
    <td colspan="2" align="left" valign="top"><input type="submit" value="Generate" name="generate" id="search"/></td>
    </tr>
  <tr>
    <td height="12">&nbsp;</td>
...
<form  name="form1" method="post"  action=""> 
<input type="submit" value="Generate" name="generate" id="search"/>
</form>
 </td>


    <td width="51%"><form  name="form1" method="post"  action=""> 
 <div>    
 <fieldset>
...
//instantiate class and set properties
$myCalendar = new tc_calendar("payment_date1", true);
$myCalendar->setIcon("../images/calender/iconCalendar.gif");
$myCalendar->setDate(1, 1, 2012);
...
?></td>
  ...
  <tr>
    ...
    <td><input type="submit" value="Search" name="search2" id="search2"/></td>
  </tr>
</table>
</fieldset>
</div> 
