...
<fieldset>
 ...
 <tr>
  ...
  <tr>
    <td align="left">Referee One Phone Number:</td>
    <td align="left"><input type="text" name="referee1_ phone" id="referee1_ phone" value="<?php echo $_POST['referee1_ phone'];?>"/></td>
  </tr> 
  <tr>
  ...
  <tr>
    ...
    <td align="left"><input type="text" name="referee2_ phone" id="referee2_ phone" value="<?php echo $_POST['referee2_ phone'];?>"/></td>
    </tr>
  <tr>
