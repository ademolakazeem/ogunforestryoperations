 ...
 <table width="100%" border="0" cellspacing="5" cellpadding="5">
  ...
  <tr>
    ...
    <td align="left"><?php
        ...
        //echo $rs1['amount_deposited'];
        $newBallance = $rs1['amount_deposited'];
        echo "&#8358;".number_format($newBallance, 2);
...
<!--<input type="text" name="amount_deposited" id="amount_deposited" value="<?php echo $_POST['amount_deposited'];?>"/>-->
  ...
  <tr>
      <td align="left">Pass Hammer Number:</td>
      <td><input type="text" name="phn" id="phn" value="<?php echo $_POST['phn'];?>"/></td>
  </tr>
  <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
  ...
  <tr>
      ...
      <td><input type="text" name="snl" id="snl" value="<?php echo $_POST['snl'];?>"/></td>
  </tr>
  <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
  ...
  <tr>
      ...
      <td><input type="text" name="locn" id="locn" value="<?php echo $_POST['locn'];?>"/></td>
  </tr>
  <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
