...
class pagination_count {
	var $full_sql, $full_sql_count, $per_page, $cur_page, $tot_pages, $offset, $gettotal;
	
	function pagination_count($full_sql, $per_page, $cur_page)
	{
	...
	function pagination_ct($full_sql_count)
	{
		$this->full_sql_count=$full_sql_count;
		$sqltct=$full_sql_count;
		$rsdtct = mysql_query($sqltct);
		$this->getCount =$rsdtct;
