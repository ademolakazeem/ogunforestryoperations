...
<td width="219" align="left"><?php echo $rs['id'];?></td>
          </tr>

        <tr>
          <td height="32" align="left"><strong>Contractor's Name:</strong></td>
          <td align="left"><?php echo $rs['name'];?></td>
          </tr>
       <!-- <tr>
          ...
          -->
          <tr>
          <td height="38" align="left"><strong> Hammer Number:</strong></td>
          <td align="left"><?php  echo $rs['hammer_number'];?></td>
          </tr>
        <tr>
          <td height="46" align="left"><strong> Reg No:</strong></td>
          <td align="left"><?php echo $rs['company_reg_number']; ?></td>
        </tr>
        <tr>
          <td height="38" align="left"><strong>Phone:</strong></td>
          <td align="left"><?php echo $rs['phone'];?></td>
        </tr>
        <tr>
          <td height="25" align="left"><strong>Address:</strong></td>
          <td align="left"><?php echo $rs['address'];?></td>
        </tr>
        <tr>
          <td height="31" align="left"><strong>Business Area:</strong></td>
          <td align="left"><?php echo $rs['business_area'];?></td>
        </tr>
        <tr>
          <td height="33" align="left"><strong>Referee One Name:</strong></td>
          <td align="left"><?php echo $rs['referee1_name'];?></td>
        </tr>
        <tr>
          <td height="28" align="left"><strong>Referee One Address:</strong></td>
          <td align="left"><?php echo $rs['referee1_address'];?></td>
        </tr>
        <tr>
          <td height="37" align="left"><strong>Referee One Phone:</strong></td>
          <td align="left"><?php echo $rs['referee1_phone'];?></td>
        </tr>
        <tr>
          <td height="40" align="left"><strong>Referee Two Name:</strong></td>
          <td align="left"><?php echo $rs['referee2_name'];?></td>
        </tr>
        <tr>
          <td height="35" align="left"><strong>Referee Two Address:</strong></td>
          <td align="left"><?php echo $rs['referee2_address'];?></td>
        </tr>
        <tr>
          <td height="33" align="left"><strong>Referee Two Phone:</strong></td>
          <td align="left"><?php echo $rs['referee2_phone'];?></td>
        </tr>
        <tr>
          <td height="43" align="left"><strong>Created By:</strong></td>
