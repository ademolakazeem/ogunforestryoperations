...
<?php 
	...
	//pagination
		...
		{
			$full_sql = "select * from tbl_contractor order by datereg desc"; //full sql before split in to pages
		}
...
<table width="350" border="0" align="left">
 ...
 <td align="center"><a href="man_contractor.php?con_id=<?php echo $rs['id'];?>" title="Administer <?php echo $rs['name'];?>">Administer</a></td>
                        </tr>
                        <?php $i++;}?>
                      </tbody>
                      <tfoot>
