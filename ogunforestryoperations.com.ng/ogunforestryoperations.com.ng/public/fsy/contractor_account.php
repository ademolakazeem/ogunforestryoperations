...
<?php 
	...
	$location = "";        
        ...
        if(isset($_SESSION['levelaccess']) && isset($_SESSION['location']) )
	{
		$acc_level= $_SESSION['levelaccess'];
		$location= $_SESSION['location'];
	}

	$qry1 = "SELECT * FROM tbl_contractor WHERE id = '".$_SESSION['username']."'";

	$qry = "SELECT * FROM tbl_contractor_account WHERE contractor_id = '".$_SESSION['username']."'";
