...
//page permission id = 12, permission name =  view contractor_transaction_reports
...
<?php 
	...
	//pagination
		...
		$full_sql = "select * from tbl_contractor order by name";
...
<div class="content">
						<h4>
					      ...
					      <br>
				        Please select any of the following criteria to generate Contractor Transaction Reports<a href="_registration.php" title="Register new staff" class="green"></a></h4>
...
<table width="100%" border="0" cellspacing="5" cellpadding="5">
  ...
  <tr>
    <td width="51%"><form  name="form1" method="post"  action="contractor_transaction_reports.php" target="_blank"> 
 <div> 

<table width="400" border="0" align="left">
  <tr><td height="26" align="left" valign="top">Contractor's ID:</td>
    <td><p>
      <input type="text" name="contractor_id" id="keyword" size="20"/>
...
?></td>
  ...
  <tr>
    ...
    |<a href="contractor_transaction_reports.php" target="_blank"> Generate without Criteria</a></td>
  </tr>
</table>
</div> 
</form> </td>
