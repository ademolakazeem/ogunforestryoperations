...
<div class="content">
						<h4>
					      ...
					      <br>
				        Please select any of the following criteria to generate Contractor Account Reports<a href="_registration.php" title="Register new staff" class="green"></a></h4>
...
<table width="100%" border="0" cellspacing="5" cellpadding="5">
  ...
  <tr>
    <td width="51%"><form  name="form1" method="post"  action="contractor_account_reports.php" target="_blank"> 
 <div> 
...
?></td>
  ...
  <tr>
    ...
    |<a href="contractor_account_reports.php" target="_blank"> Generate without Criteria</a></td>
  </tr>
</table>
</div> 
</form> </td>
