...
form.action='_new_user_account_preview.php';
form.submit();
}
//-->
</script> 
...
<br/>
<fieldset>
   <form id="form" name="form" method="post" action="_new_user_account_preview.php">
   
 <table width="100%" border="0" cellspacing="5" cellpadding="5">
  <tr>
    <td colspan="2" align="center"><h3>User Registration <strong><span class="green">Page</span></strong></h3>	</td>
    </tr>
  <tr>
...
<select name="title" id="title">
  ...
  <tr>
    ...
    <td><input type="text" name="fname" id="fname" value="<?php echo $_POST['fname'];?>"/></td>
    </tr>
  <tr>
    <td align="left">Middlename:<br></td>
    <td align="left"><input type="text" name="mname" id="mname" value="<?php echo $_POST['mname'];?>"/></td>
    </tr>
  <tr>
    <td align="left">Lastname:</td>
    <td align="left"><input type="text" name="lname" id="lname" value="<?php echo $_POST['lname'];?>"/></td>
    </tr>
  <tr>
...
?>
  ...
  <tr>
    ...
    <td align="left"><input type="text" name="user" id="user" value="<?php echo $_POST['user'];?>"/></td>
    </tr>
  <tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><input type="password" name="re_password" id="re_password" value=""/></td>
    </tr>
  <tr>
  <tr>
    <td align="left">Department:</td>
    <td align="left"><input type="text" name="dep" id="dep" value="<?php echo $_POST['dep'];?>"/></td>
    </tr>
  <tr>
  <tr>
    <td align="left">Rank:</td>
    <td align="left"><input type="text" name="rank" id="rank" value="<?php echo $_POST['rank'];?>"/>
      </td>
    </tr>
  <tr>  
 <tr>
    <td align="left">Qualification:</td>
    <td align="left"><input type="text" name="qua" id="qua" value="<?php echo $_POST['qua'];?>"/>
      </td>
    </tr>
  <tr>
   ...
   <tr>
    ...
    <td align="left"><input type="text" name="email" id="email" value="<?php echo $_POST['email'];?>"/></td>
    </tr>
       
 <tr>
    <td align="left">Address:</td>
    <td align="left"><textarea name="address" id="address" cols="35" rows="3"><?php echo $_POST['address'];?></textarea></td>
    </tr>
  <tr>
